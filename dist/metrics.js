...
var Metrics = /** @class */ (function () {
    ...
    Metrics.prototype.init = function (db, onInit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.db = db;
                        this.influx = new influx_1.InfluxDB("http://testconnect@localhost:8086/testdb");
                        return [4 /*yield*/, this.influx.getDatabaseNames()];
                    case 1:
                        dbs = _a.sent();
